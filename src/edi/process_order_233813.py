#!/usr/bin/env python3
"""
Process DABS Licensee Order ID 233813 to NAXML EDI Format
...
async def process_dabs_order():
    print('🔄 Processing DABS Licensee Order ID 233813...')
    
    # Initialize the complete EDI system
    system = DABSEDICompleteSystem()
    
    # Process the PDF file
    pdf_file = Path('../../dabs/Licensee Orders_id_233813.pdf')
    ...
    if pdf_file.exists():
        ...
        result = await system.process_dabs_file(
            ...
            invoice_number='DABS_ORDER_233813'
        )
...
if __name__ == "__main__":
    ...
    if result and result['success']:
        print(f'\n🎉 SUCCESS: DABS Order 233813 processed successfully!')
